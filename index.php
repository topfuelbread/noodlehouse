	...
	<body>
		...
		<?php
			if(isset($_SESSION['userid'])){
				...
				echo '<h1>Welcome to Noodle House, since you are logined in, you get access to our members only menu ! ! !</h1>
					<p>The #1 spot to order our heavenly meals. Try out our famous pho noodle soups or hop on in to get our freshly made salads!';

			}else{
				echo'<h4>Sorry, this is a members only restaurant, in order to get access to our website, please login if you are a member, otherwise simply click Signup.</h1>';
			}
		?>
					</article>
				</main>
